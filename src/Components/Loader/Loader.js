...
export default function Loader() {
  return (
    <React.Fragment>
      <div style={{ width: "84px", textAlign: "center", zIndex: 2 }}>
        <div className="landing-loader" id="frame-loader">
          <svg
            className="ldi-zbvw97"
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          ...
                          animationDelay: "-1.346153846153846s",
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: "-1.2923076923076924s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: "-1.2384615384615383s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: "-1.1846153846153846s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: " -1.1307692307692307s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: "-1.0769230769230769s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: " -1.023076923076923s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
                    ...
                    <g style={{ transformOrigin: "50px 50px 0" }}>
                      <g
                        ...
                        style={{
                          transformOrigin: "50px 50px 0",
                          animationDuration: "1.4s",
                          animationDelay: "-0.9692307692307691s",
                          animationDirection: "normal",
                        }}
                      >
                        <path
